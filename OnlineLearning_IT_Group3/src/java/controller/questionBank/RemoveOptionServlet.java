 ...
 * @author ADMIN
 */
@WebServlet(name = "RemoveOptionServlet", urlPatterns = {"/removeOptionServlet"})
public class RemoveOptionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RemoveOptionServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RemoveOptionServlet at " + request.getParameter("answerOptionId") + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
