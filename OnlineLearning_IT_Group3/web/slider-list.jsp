...
<html>
    ...
    <label>
        <input type="checkbox" name="columns" value="title" <c:if test="${columns != null && columns.contains('title')}">checked</c:if>> Title
    </label>
    <label>
        <input type="checkbox" name="columns" value="backLink" <c:if test="${columns != null && columns.contains('backLink')}">checked</c:if>> BackLink
    </label>
    <label>
        <input type="checkbox" name="columns" value="description" <c:if test="${columns != null && columns.contains('description')}">checked</c:if>> Description
    </label>
    <label>
        <input type="checkbox" name="columns" value="publish" <c:if test="${columns != null && columns.contains('publish')}">checked</c:if>> Publish
    </label>
    <label>
        <input type="checkbox" name="desc" value="desc" <c:if test="${param.desc != null && param.desc == 'desc'}">checked</c:if>> Desc
    </label>
