                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="course-item shadow">
                            <div class="position-relative overflow-hidden image">
                                <img class="img-fluid" src="img/course-<%= i %>.jpg" alt="Course <%= i %>">
                            ...
                            <div class="p-2 pb-0">
                                <h5 class="mb-1"><a href="single.html" class="text-dark">Registration for Course <%= i %></a></h5>
                                <p class="mb-1"><strong>ID:</strong> #<%= 1000 + i %></p>
                                <p class="mb-1"><strong>Registration Time:</strong> 2024-10-<%= 10 + i %> 10:00 AM</p>
                                <p class="mb-1"><strong>Package:</strong> Standard Package</p>
                                <p class="mb-1"><strong>Total Cost:</strong> ₹ <%= 5000 + i * 100 %></p>
                                ...
                                <p class="mb-1"><strong>Valid From:</strong> 2024-10-<%= 10 + i %></p>
                                <p class="mb-1"><strong>Valid To:</strong> 2025-10-<%= 10 + i %></p>
                            </div>
                            <div class="d-flex">
