<%-- 
    Document   : courseRegistrations
    Created on : Oct 1, 2024, 4:16:39 PM
    Author     : laptop acer
--%>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title bg-white text-center px-3">My Courses Registration</h6>                    
                </div>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="course-item shadow">
                                <div class="position-relative overflow-hidden image">
                                    <img class="img-fluid" src="img/course-${registration.courseId}.jpg" alt="Course ${registration.courseId}">
                                ...
                                <div class="p-2 pb-0">
                                    <h5 class="mb-1"><a href="single.html" class="text-dark">Registration for Course ${registration.courseId}</a></h5>
                                    <p class="mb-1"><strong>ID:</strong> ${registration.courseId + 1000}</p>
                                    <p class="mb-1"><strong>Package:</strong> ${registration.packageName}</p>
                                    <p class="mb-1"><strong>Total Cost:</strong> $ ${registration.price}</p>
                                    <p class="mb-1"><strong>Status:</strong>
                                    <c:choose>
                                        <c:when test="${registration.status == 'Confirmed'}">Confirmed</c:when>
                                        <c:otherwise>Submitted</c:otherwise>
                                    </c:choose>
                                    </p>
<!--                                    <p class="mb-1"><strong>Valid From:</strong> ${registration.validFrom}</p>
                                    <p class="mb-1"><strong>Valid To:</strong> ${registration.validTo}</p>-->
                                </div>
                                <div class="d-flex">
                                    <small class="flex-fill text-left py-1 px-2"><i class="fa fa-clock me-2"></i>2.0 Hrs</small>
                                    ...
                                    <small class="text-primary py-1 px-2 fw-bold fs-6" style="float:right;">
                                        ...
                                        <a href="#">Enroll Now</a><i class="fa fa-chevron-right me-2 fs-10"></i>
                                    </small>
                                </div>
                            </div>
                        </div>
