<%-- 
    Document   : updateMooc
    Created on : Nov 8, 2024, 11:10:23 AM
    Author     : DTC
--%>
    ...
    <body>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <form action="updateMooc" method="post">
                    <input type="text" value="${courseid}" name="courseid" hidden="">
                    <input type="text" value="${moocid}" name="moocid" hidden="">
                    ...
                    <div style="margin-top: 30px">
                        ...
                        <input style="width: 500px;" type="text" name="moocname" value="${name}">
                    </div>
